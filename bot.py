...
from handlers.helpers import b64_to_str, str_to_b64, format_time_seconds, decode_link
...
async def start(bot: Client, cmd: Message):
    ...
    # Handle file access — new secure encrypted link format
    try:
        await add_user_to_database(bot, cmd)
        ...
        GetMessage = await bot.get_messages(chat_id=channel_id, message_ids=message_id)

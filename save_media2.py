...
async def save_batch_media_in_channel(bot: Client, editable: Message, message_ids: list):
    try:
        ...
        # Generate share link
        raw_link = f"https://t.me/{Config.BOT_USERNAME}?start=mrkiller_{str_to_b64(str(SaveMessage.id))}"
...
async def save_media_in_channel(bot: Client, editable: Message, message: Message):
    try:
        ...
        # Generate share link
        raw_link = f"https://t.me/{Config.BOT_USERNAME}?start=mrkiller_{str_to_b64(file_er_id)}"

    ...
    try:
        ...
        async def clone_save(bot, message):
            try:
                ...
                # Use serve bot to save file to DB_CHANNEL
                # Serve bot IS admin in DB_CHANNEL and shares same api_id/api_hash
                from handlers.serve_bot import save_to_db_channel
                forwarded = await save_to_db_channel(tg_file_id, media_type, original_caption)

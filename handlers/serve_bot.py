                ...
                try:
                    ...
                    if not user_id and Config.STREAM_ENABLED and Config.STREAM_FQDN:
                        try:
                            ...
                            # Get filename from the file message
                            ...
                            if file_msg:
                                ...
                                fn = getattr(media, 'file_name', None) or "file"
                            buttons.append([
                                InlineKeyboardButton("▶️ Stream", url=get_stream_link(mid_int, fn)),
                                InlineKeyboardButton("📥 Download", url=get_download_link(mid_int, fn))
                            ])
                        except Exception:
                            pass
